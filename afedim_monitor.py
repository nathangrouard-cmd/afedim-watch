...
def main():
    ...
    # On sauvegarde l'etat actuel a CHAQUE execution, meme s'il n'y a
    # aucune nouvelle annonce -- sinon les annonces retirees du site
    # (louees, expirees...) ne sont jamais nettoyees du fichier tant
    # qu'aucune nouveaute ne se presente.
